...
<% 
	...
	strConn	   += "Initial Catalog=bsouter;Data Source=sdssdb002.pha.jhu.edu;";           	
	oConn.Open(strConn); 	
...
%>
 <meta charset="utf-8">
    ...
    <title>Ho Ho PHA Holiday Party 2014</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 section">
            <h1 class="section-heading" style="color:#7B1A00">Ho! Ho! Ho!</h1>
            <h3 class="section-paragraph">The Annual PHA Holiday Party 2014 is coming up on Friday Dec 12th!</h3>
            <h3 class="lead section-lead">We would love to see you there! Please bring your favorite dish to share. Fill out the form <a href="#signup"><strong>below</strong></a> with your contribution and press Submit when done. Feel free to be creative about your comments!</h3>
              <div class="row">
              <div class="col-md-2 col-md-offset-3"><center><span class="glyphicon glyphicon-tree-conifer" style="font-size:56px; color: #005826;"></span></center></div> 
                  <div class="col-md-2"><center><span class="glyphicon glyphicon-star" style="font-size:56px; color: #255F7B;"></span></center></div>
                      <div class="col-md-2"><center><span class="glyphicon glyphicon-tree-conifer" style="font-size:56px; color: #005826;"></span></center></div>
              </div>
          </div>
      </div>
    </div>
